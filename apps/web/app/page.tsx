...
const features = [
  ...
  },
  {
    ...
    description:
      "Generate compelling content with GPT-4, Claude, Gemini, Grok, and DeepSeek. Repurpose across platforms with a single click.",
  },
  {
    icon: Calendar,
      ...
      <section className="relative px-6 pb-24 pt-20 sm:pt-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="fade-in-up mb-8 inline-flex items-center gap-2 rounded-full border bg-background/80 px-4 py-1.5 text-sm text-muted-foreground backdrop-blur-sm">
            ...
            <span>Powered by AI — GPT-4, Claude, Gemini, Grok & DeepSeek</span>
          </div>
